...
parallelize processing on an onboard Nvidia GPU.  Other responsibilities included implementing fast algorithms
for person/object segmentation, triggering captures and other timing between camera and microwave images, and
