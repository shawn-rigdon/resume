...
\experience{2020-Present}{Kelly Services}{Sr. Software Developer}{
I am working as a consultant for a client on behalf of Kelly Services. This is a contract for a small research
team working on machine learning techniques for biometric security and fraud detection in images and video.
The role involves a myriad of engineering tasks focused on developing sensor platforms for deploying the machine
learning algorithms in a real-time environment. Responsibilities include software architecture, computational
optimizations, data acquisition from multiple sensing modalities, and sensor hardware prototyping (some circuit
design and CAD of a 3D printed housing). The real-time screening application uses a microservices architecture
to make each component language agnostic and to provide separation between the research and platform development.
}
